...
export class RegisterComponent implements OnInit {
  ...
  public async register(): Promise<void> {
    const { email, userName, password, confirmPassword } = this.formGroup.value;
    const credentials = { email, userName, password, confirmPassword } as {
      email: string;
      userName: string;
      password: string;
